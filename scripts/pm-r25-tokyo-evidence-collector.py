...
USER_AGENT = "pm-r25-tokyo-read-only-evidence/1.0"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Tokyo read-only evidence collector for the 0x3048 strategy")
    parser.add_argument("--config", default="config/pm-r25-tokyo-collector.json")
