...
LEGACY_ENGINE_FILES = {ENGINE_ROOT + name for name in (
    "LIVE_FILLRATE_TEST.md", "auto_optimize.sh", "ecosystem.config.js", "live-start.ps1",
    "pm2-clone-fillrate.sh", "pm2-clone.sh", "pm2-live-a.sh", "pm2-recorder-dense.sh", "status.sh",
)}
LEGACY_PROGRAM_FILES = {
    "config/pm-r25-dublin-collector.json",
    "config/pm-r25-dublin-collector.service",
    "config/pm-r25-dublin-daily-restart.service",
    "config/pm-r25-dublin-daily-restart.timer",
    "config/pm-r25-dublin-live-analyzer.service",
    "config/pm-r25-dublin-live-analyzer.timer",
    "scripts/pm-r25-binance-signal-analysis.py",
    "scripts/pm-r25-dublin-evidence-collector.py",
    "scripts/pm-r25-infer-state-machine.py",
    "scripts/pm-r25-live-evidence-analysis.py",
    "tests/test_pm_r25_binance_signal.py",
    "tests/test_pm_r25_collector.py",
    "tests/test_pm_r25_live_analysis.py",
    "tests/test_pm_r25_state_machine.py",
}
...
def release_path(name: str) -> bool:
    return (name.startswith(PROGRAM_PREFIXES) or name.startswith("docs/") or name in ENGINE_METADATA
            or name in LEGACY_ENGINE_FILES or name in LEGACY_PROGRAM_FILES
            or name in {"README.md", "START-HERE.md", "scripts/system-dashboard-server.py",
                                                        "scripts/deploy-reversal-release.py",
                                                        "contracts/config-v1.md",
                                                        "config/pm-system-dashboard-dublin.service",
                                                        "config/pm-clob-market-snapshot.service"}
            or name.startswith("tests/test_dashboard")
            or name in {"tests/test_reversal_dashboard.py", "tests/test_system_dashboard_config.py", "tests/test_market_snapshot.py"})
...
allowed_prefixes=('_external/btc-5m-market-trading-bot/','web/src/','scripts/dashboard/','docs/','tests/')
allowed_exact={'README.md','START-HERE.md','scripts/system-dashboard-server.py','contracts/config-v1.md',
               'scripts/deploy-reversal-release.py',
               'config/pm-r25-dublin-collector.json','config/pm-r25-dublin-collector.service',
               'config/pm-r25-dublin-daily-restart.service','config/pm-r25-dublin-daily-restart.timer',
               'config/pm-r25-dublin-live-analyzer.service','config/pm-r25-dublin-live-analyzer.timer',
               'scripts/pm-r25-binance-signal-analysis.py','scripts/pm-r25-dublin-evidence-collector.py',
               'scripts/pm-r25-infer-state-machine.py','scripts/pm-r25-live-evidence-analysis.py',
               'tests/test_pm_r25_binance_signal.py','tests/test_pm_r25_collector.py',
               'tests/test_pm_r25_live_analysis.py','tests/test_pm_r25_state_machine.py',
               'config/pm-system-dashboard-dublin.service','config/pm-clob-market-snapshot.service'}
...
unit_names={'config/pm-system-dashboard-dublin.service':'pm-system-dashboard-dublin.service',
            ...
            'config/pm-r25-dublin-collector.service':'pm-r25-dublin-collector.service',
            'config/pm-r25-dublin-daily-restart.service':'pm-r25-dublin-daily-restart.service',
            'config/pm-r25-dublin-daily-restart.timer':'pm-r25-dublin-daily-restart.timer',
            'config/pm-r25-dublin-live-analyzer.service':'pm-r25-dublin-live-analyzer.service',
            'config/pm-r25-dublin-live-analyzer.timer':'pm-r25-dublin-live-analyzer.timer'}
