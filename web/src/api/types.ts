...
export interface Account { control_source?: ControlSource; wallet: string; wallet_configured: boolean; owner_signer_configured: boolean; relayer_api_configured: boolean; config_error: string | null; last_check: Obj | null }
