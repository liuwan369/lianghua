...
const orders=(n:number)=>Array.from({length:n},(_,i)=>({event:'order',market:'btc-five',side:'UP',time:100-i,client_order_id:`client-${i}`,order_id:`order-${i}`,direction:'BUY',status:'OPEN',shares:5,price:.7,filled_shares:0,amount:0}));
