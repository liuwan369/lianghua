    ...
    <main class="preview-main">
      ...
      <section class="metrics-panel" aria-labelledby="metrics-title">
        ...
        <div class="metrics-grid">
          <article class="metric-group"><div class="metric-heading"><span class="metric-mark blue-mark">\u5355</span><div><h3>\u8BA2\u5355\u6570</h3><p>\u5DF2\u8BB0\u5F55\u7684\u8BA2\u5355\u6570\u91CF</p></div></div><strong class="metric-primary" data-metric="orders-current">0</strong><dl class="metric-rows"><div><dt>\u4ECA\u65E5</dt><dd data-metric="orders-today">0</dd></div><div><dt>\u5F53\u6708</dt><dd data-metric="orders-month">0</dd></div></dl></article>
          <article class="metric-group"><div class="metric-heading"><span class="metric-mark amber-mark">\u76C8</span><div><h3>\u76C8 / \u4E8F</h3><p>\u80DC\u8D1F\u573A\u6B21\u7EDF\u8BA1</p></div></div><strong class="metric-primary"><span data-metric="wins-current">0</span> <em>/</em> <span data-metric="losses-current">0</span></strong><dl class="metric-rows"><div><dt>\u4ECA\u65E5</dt><dd><span data-metric="wins-today">0</span> / <span data-metric="losses-today">0</span></dd></div><div><dt>\u5F53\u6708</dt><dd><span data-metric="wins-month">0</span> / <span data-metric="losses-month">0</span></dd></div></dl></article>
