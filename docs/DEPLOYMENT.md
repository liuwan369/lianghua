...
更新：2026-09-18。当前程序基线为 `eed88b2143ffe351dc458bfd51c8280cd8bd737a`，主线为 [反转交付规划](REVERSAL-DELIVERY-PLAN-2026-09-17.md) v2.6。实时交付状态见 [CURRENT-STATUS](CURRENT-STATUS.md)，历史发布记录不代表当前版本。
