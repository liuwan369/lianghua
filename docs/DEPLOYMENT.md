...
更新时间：2026-09-16。发布和三端同步按 [交付规划 v6](STRATEGY-DELIVERY-PLAN-2026-09-13.md) 和 [Agent 协作约定 v6](AGENT-WORKFLOW.md) 执行。每批核对本地、Git 和服务器发布清单；回滚只恢复程序版本，不覆盖订单、账本和风险状态。
