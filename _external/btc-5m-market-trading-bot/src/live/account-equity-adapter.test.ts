...
const base = {
  ...
  positions: { available: true, complete: true, items: [{ conditionId: 'c1', asset: 'a1', size: '3.5', curPrice: 0.4, valuation: 'liquidation_bid' }] },
};
...
describe('account data equity adapter', () => {
  ...
  it.each([
    ...
    ['missing position price', { ...base, pagination_atomic: true, positions: { ...base.positions, items: [{ ...base.positions.items[0], curPrice: null, valuation: 'liquidation_bid' }] } }],
